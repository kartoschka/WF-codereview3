...
class LibraryItem {
  ...
  get likeCount() { 
    return Number(this._data.numLikes) + Boolean(this.likedByUser) - Boolean(this.dislikedByUser)
  }
  get likedByUser() { 
      ...
      [["div", null, this._cprefix + "imgbox",
       ...
       ["div", null, this._cprefix + "info",         
         [["h3", null, this._cprefix + "title"   , this._data.title],                                                                   
          ...
          ["ul", null, this._cprefix + "ratebox" , [["li", null, this._cprefix + "like-button"   , this._like_button],
